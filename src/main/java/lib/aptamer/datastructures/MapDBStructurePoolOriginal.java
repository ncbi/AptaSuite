 ...
 */
public class MapDBStructurePoolOriginal implements StructurePool {
	 ...
	 */
	public MapDBStructurePoolOriginal(Path projectPath, String poolName, int maxTreeMapCapacity, boolean newdb) throws IOException{
